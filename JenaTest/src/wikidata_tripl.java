...
public class wikidata_tripl {
	static public void main(String[] args) throws FileNotFoundException{
        ...
        try{
	        ...
	        out = new FileOutputStream("output/SPARQL-output_tripl2.txt");
			//out = new FileOutputStream("output/SPARQL-output_tripl.csv");
